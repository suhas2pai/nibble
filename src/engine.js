...
function navHTML() {
  const t = [['learn', 'Learn', ic.home()], ['practice', 'Practice', ic.loop()], ['plans', 'Plans', ic.gem()], ['account', 'Account', ic.user()]];
...
function render() {
  ...
  const view = S.tab === 'learn' ? homeHTML() : S.tab === 'practice' ? practiceHTML() : S.tab === 'plans' ? plansHTML() : accountHTML();
